...
_lr_productions = [
  ...
  ('insert -> INSERT INTO DATASOURCE icolumn VALUES insert_values SIMICOLON','insert',7,'p_insert','yacc.py',68),
  ('update -> UPDATE DATASOURCE SET assigns where SIMICOLON','update',6,'p_update','yacc.py',80),
  ('delete -> DELETE FROM DATASOURCE where','delete',4,'p_delete','yacc.py',92),
  ('logical -> EQUAL','logical',1,'p_logical','yacc.py',105),
  ('logical -> NOTEQUAL','logical',1,'p_logical','yacc.py',106),
  ('logical -> BIGGER_EQUAL','logical',1,'p_logical','yacc.py',107),
  ('logical -> BIGGER','logical',1,'p_logical','yacc.py',108),
  ('logical -> SMALLER_EQUAL','logical',1,'p_logical','yacc.py',109),
  ('logical -> SMALLER','logical',1,'p_logical','yacc.py',110),
  ('where -> WHERE conditions','where',2,'p_where','yacc.py',120),
  ('where -> empty','where',1,'p_where_empty','yacc.py',124),
  ('conditions -> LPAREN conditions RPAREN','conditions',3,'p_cond_parens','yacc.py',128),
  ('conditions -> conditions AND conditions','conditions',3,'p_cond_3','yacc.py',132),
  ('conditions -> conditions OR conditions','conditions',3,'p_cond_3','yacc.py',133),
  ('conditions -> exp LIKE STRING','conditions',3,'p_cond_3','yacc.py',134),
  ('conditions -> exp logical exp','conditions',3,'p_cond_3','yacc.py',135),
  ('conditions -> NOT conditions','conditions',2,'p_conditions_not','yacc.py',139),
  ('exp -> STRING','exp',1,'p_exp','yacc.py',149),
  ('exp -> COLNAME','exp',1,'p_exp','yacc.py',150),
  ('exp -> NUMBER','exp',1,'p_exp','yacc.py',151),
  ('distinct -> DISTINCT','distinct',1,'p_distinct','yacc.py',161),
  ...
  ('columns -> column','columns',1,'p_columns_base','yacc.py',184),
  ('select_columns -> TIMES','select_columns',1,'p_select_columns_all','yacc.py',193),
  ('select_columns -> columns','select_columns',1,'p_select_columns','yacc.py',197),
  ('into -> INTO DATASOURCE','into',2,'p_into','yacc.py',207),
  ('into -> empty','into',1,'p_into_empty','yacc.py',211),
  ('order -> ORDER BY column way','order',4,'p_order_by','yacc.py',221),
  ('order -> empty','order',1,'p_order_empty','yacc.py',225),
  ('way -> ASC','way',1,'p_way_asc','yacc.py',229),
  ('way -> empty','way',1,'p_way_asc','yacc.py',230),
  ('way -> DESC','way',1,'p_way_desc','yacc.py',234),
  ('limit -> LIMIT NUMBER','limit',2,'p_limit','yacc.py',244),
  ('limit -> empty','limit',1,'p_limit_empty','yacc.py',251),
  ('value -> STRING','value',1,'p_value','yacc.py',260),
  ('value -> NUMBER','value',1,'p_value','yacc.py',261),
  ('values -> value COMMA values','values',3,'p_values','yacc.py',265),
  ('values -> value','values',1,'p_values_end','yacc.py',269),
  ('single_values -> LPAREN values RPAREN','single_values',3,'p_single_values','yacc.py',273),
  ('insert_values -> single_values COMMA insert_values','insert_values',3,'p_insert_values','yacc.py',279),
  ('insert_values -> single_values','insert_values',1,'p_insert_values_end','yacc.py',283),
